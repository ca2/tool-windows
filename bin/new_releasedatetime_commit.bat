...
set versionfile=M:\basis\platform-windows\version
...
echo %buildinclude% > M:\basis\platform-macos\build.h

echo %buildinclude% > M:\basis\platform-linux\build.h

echo %buildinclude% > M:\basis\platform-windows\build.h
