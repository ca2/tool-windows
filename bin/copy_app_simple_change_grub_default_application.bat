...
copy "%archive%\tool-windows\lnk\Change GRUB default entry.lnk" "%APPDATA%\Microsoft\Windows\Start Menu\Programs\"
copy "%archive%\tool-windows\lnk\Change GRUB default entry.lnk" "%APPDATA%\Microsoft\Windows\Start Menu\Programs\Startup\"
